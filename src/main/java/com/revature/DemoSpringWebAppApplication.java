...
public class DemoSpringWebAppApplication {
	...
	public void initDb() {
		...
		Set<ApplicationAuthority> managerAuthority = new HashSet<>();
		managerAuthority.add(new ApplicationAuthority("ROLE_MANAGER"));
		managerAuthority.add(new ApplicationAuthority("ROLE_USER"));
		...
		user.setAuthorities(managerAuthority);
		
		UserInformation info = new UserInformation();
		info.setFirstname("William");
		info.setLastname("Gentry");
		info.setEmail("william.gentry@revature.com");
		info.setStreet("123 Main Street");
		info.setCity("Suwanee");
